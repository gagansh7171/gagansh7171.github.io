                    ...
                    <Grid container >
                        ...
                        <Grid item xs={10}>
                            ...
                            <Grid item xs={12} md={6} lg={4} className={classes.alignCenter}>
                                <div className={classes.hover}><img src="./assets/certi/newton.png" className ={classes.image}/></div>
                            </Grid>
                            <Grid item xs={12} md={6} lg={4} className={classes.alignCenter}>
                                    <div className={classes.hover}><img src="./assets/certi/airblack.png" className ={classes.image}/></div>
                            </Grid>
                            <Grid item xs={12} md={6} lg={4} className={classes.alignCenter}>
